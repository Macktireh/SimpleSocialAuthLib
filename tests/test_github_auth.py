...
def test_sign_in_success(mock_exchange: MagicMock, mock_retrieve: MagicMock, github_auth: GithubSocialAuth) -> None:
    ...
    user_data = github_auth.sign_in(code="test_code", received_state=test_state, saved_state=test_state)
...
def test_sign_in_code_exchange_failure(mock_exchange: MagicMock, github_auth: GithubSocialAuth) -> None:
